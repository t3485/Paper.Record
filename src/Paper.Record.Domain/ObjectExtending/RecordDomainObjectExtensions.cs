...
namespace Paper.Record.ObjectExtending
{
    public static class RecordDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the RecordEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
